...
| [11 Ранжирование текстов на основе эмбеддингов](https://github.com/DEDMOPO3PEAHIMATOP/Deep-Learning/blob/main/simple_embeddings.ipynb)| Ранжирование текстов на основе эмбеддингов. | collections, cv2, itertools, gc, matplotlib, numpy, os, pandas, pickle, PIL, pytorch_metric_learning, skimage, timm, torch, torchmetrics, torchvision, tqdm
