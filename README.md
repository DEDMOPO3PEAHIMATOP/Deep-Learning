...
| [12 Нейросетевая классификация текстов](https://github.com/DEDMOPO3PEAHIMATOP/Deep-Learning/blob/main/hw_text_classification.ipynb)| Нейросетевая классификация текстов. | collections, datasets, gc, matplotlib, nltk, numpy, seaborn, sklearn, string, torch, tqdm, typing
